...
import com.example.monaly.ui.fragment.onboarding.OnboardingOne.Companion
...
class OnboardingTwo : Fragment() {
    ...
    override fun onCreateView(
        ...
        arguments?.let {
            ...
            title.text = it.getString(OnboardingOne.KEY_TITLE_ONBOARDING)
            description.text = it.getString(OnboardingOne.KEY_DESC_ONBOARDING)
